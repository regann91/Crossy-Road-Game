...
Path::Path(float roadZ, float roadWidth, glm::vec4 color, int nbObj, float objD)
    : GameObject(0, 0, roadZ+50, roadWidth, 10, 100, color), nbObjPerLane(nbObj), objWidth(objD) {}
