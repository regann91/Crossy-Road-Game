...
public:
    ...
    // Constructor
    Path(float roadY, float roadZ, float roadDepth, glm::vec3 color, int nbObj = 3, float objD = 50.0, std::string tex = "defaultTex.bmp", std::string normals = "groundNormals.bmp");
